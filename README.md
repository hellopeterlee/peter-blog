...
如果你想要搭建一个类似的站点，可直接 [Fork](https://github.com/hellopeterlee/blog/fork) 本仓库使用
...
```bash
git clone https://github.com/hellopeterlee/peter-blog.git
cd peter-blog
pnpm install
pnpm start
```
...
<img width="1471" alt="Live Demo" src="https://github.com/hellopeterlee/peter-blog/blob/main/static/img/og.png?raw=true">
