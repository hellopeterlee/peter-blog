...
并且大部分项目都是在 [Vercel](https://vercel.com) 上运行的（Vercel 是真好用），但是最近国内访问 vercel 情况不容乐观，貌似被墙了呜呜。然后 Gitlab 的资源占用非常严重，几乎占用了一半的服务器性能，可 [点我](https://kuizuo.me/gitlab-code-management-environment#运行状态) 查看运行状态。与此同时，随着很多私有项目越来越多，使用 git 私有仓库以及 Vercel 部署，肯定不如自建私有 git 服务和自有服务器部署使用体验来好。
...
![](https://img.kuizuo.me/8ix-AMvt3t.png)
...
从其他第三方 git 仓库迁移到 gitea，可以访问[https://git.kuizuo.me/repo/migrate](https://git.kuizuo.me/repo/migrate 'https://git.kuizuo.me/repo/migrate') 来迁移仓库

![](https://img.kuizuo.me/sRQV5hAKUh.png)

稍等片刻，取决于访问 github 仓库的速度。有可能还会迁移失败，就像下面这样。

![](https://img.kuizuo.me/X9IpG2q36n.png)
...
![](https://img.kuizuo.me/Rug0AmD8GE.png)
...
![](https://img.kuizuo.me/Q5IaHnKCYJ.png)
...
![](https://img.kuizuo.me/6XBrsAY8VE.png)
...
![](https://img.kuizuo.me/PAM6QQS1V_.png)

静等 PIPELINE 执行完毕，结果如下

![image-20220928152635955](https://img.kuizuo.me/20220928152635955.png)

此时打开宝塔，跳转到指定目录下，就可以看到构建的内容都已经放到指定位置了

![image-20220928152725853](https://img.kuizuo.me/20220928152725853.png)
