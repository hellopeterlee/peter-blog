---
slug: react-hook-tutorial-10
title: React Hook系列教程-10 useCallback基础用法
date: 2024-03-23
authors: peterlee
tags: [php, develop]
keywords: [php, develop]
---
React Hook系列教程 - 10 useCallback基础用法
<!-- truncate -->
...
```
请记住以下2点：  
1、React.memo()只会帮我们做浅层对比，例如`props.name='puxiao'`或`props.list=[1,2,3]`，如果是props中包含复杂的数据结构，例如props.`obj.list=[{age:34}]`，那么有可能达不到你的预期，因为不会做到深层次对比。  
